...
async def channel_post(client: Client, message: Message):
    reply_text = await message.reply_text("⏳️ لطفا صبر کنید...", quote = True)
    try:
        ...
        print(e)
        await reply_text.edit_text("❌️ چیزی با مشکل مواجه شد!")
        return
    ...
    await reply_text.edit(f"<b>🔗 لینک دانلود این فایل:</b>\n\n{link}", reply_markup=reply_markup, disable_web_page_preview = True)
